...
import com.hp.up.core.utils.shortMsg.aliMsg.MsgConfig;
 ...
 * Created by haopeng on 2017/10/28  10:46.
 */
@Service
public class AliMessageServiceImpl implements AliMessageService{
    ...
    public static SendSmsResponse sendMsg(String phoneNumber, String code) throws ClientException {
...
//        request.setTemplateParam("{\"name\":\"Tom\", \"code\":\"123\"}");
    ...
    public static QuerySendDetailsResponse querySendDetails(String bizId,String phoneNumber) throws ClientException {
        ...
        SimpleDateFormat ft = new SimpleDateFormat(FORMAT_PATTERN);
    ...
    public void afterPropertiesSet() throws Exception {
        accessKeyID = msgConfig.getAccessKeyID();
        accessKeySecret = msgConfig.getAccessKeySecret();
        signName = msgConfig.getSignName();
       templateCode = msgConfig.getTemplateCode();
    }
