...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico"> <link href="${ctx}/static/css/bootstrap.min.css?v=3.3.5" rel="stylesheet">
        ...
        <div class="ibox-content">
          ...
          <div>
            <div class="feed-activity-list">
              ...
              <div class="feed-element">
                <a href="profile.html" class="pull-left">
                  <img alt="image" class="img-circle" src="${ctx}/static/img/a2.jpg">
                </a>
                <div class="media-body ">
              ...
              <div class="feed-element">
                <a href="profile.html" class="pull-left">
                  <img alt="image" class="img-circle" src="${ctx}/static/img/a5.jpg">
                </a>
                <div class="media-body ">
...
<script src="${ctx}/static/js/demo/sparkline-demo.min.js"></script>
<script>
