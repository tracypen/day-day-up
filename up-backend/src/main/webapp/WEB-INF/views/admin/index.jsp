...
<div id="wrapper">
    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        ...
        <div class="sidebar-collapse">
            <ul class="nav" id="side-menu">
                <li class="nav-header">
                    <div class="dropdown profile-element">
                        ...
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                <span class="clear">
                               <span class="block m-t-xs"><strong class="font-bold"><shiro:principal type="com.hp.up.backend.shiro.UserShiro" property="name"></shiro:principal></strong></span>
                ...
                <li>
                    <a href="#"><i class="fa fa-cutlery"></i> <span class="nav-label">系统监控 </span><span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level">
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
                        ...
                        <ul class="dropdown-menu dropdown-messages">
                            <li class="m-t-xs">
                                <div class="dropdown-messages-box">
                                    <a href="${ctx}/profile.html" class="pull-left">
        ...
        <div class="row content-tabs">
            ...
            <a href="${ctx}/logout.action" class="roll-nav roll-right J_tabExit"><i class="fa fa fa-sign-out"></i> 退出</a>
        </div>
        <div class="row J_mainContent" id="content-main">
            <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="${ctx}/admin/welcomePage" frameborder="0" data-id="index_v2.html" seamless></iframe>
        </div>
        <div class="footer">
...
<script type="text/javascript" src="${ctx}/static/js/contabs.min.js"></script>
