...
function _getInitHtml(themesPath, bodyClass, cssPath, cssData) {
	var arr = [
		(_direction === '' ? '<html xmlns="http://www.w3.org/1999/xhtml" xmlns:mml="http://www.w3.org/1998/Math/MathML">' : '<html dir="' + _direction + '" xmlns="http://www.w3.org/1999/xhtml" xmlns:mml="http://www.w3.org/1998/Math/MathML">'),
		'<head><meta charset="utf-8" /><title>KindEditor</title>',
		'<object id="mmlFactory" classid="clsid:32F66A20-7614-11D4-BD11-00104BD3F987" style="display:none;"></object>',
		'<import namespace="mml" implementation="#mmlFactory"></import>',
		'<style>',
	...
	self.afterCreate(function() {
		...
		function movePastedData() {
			...
			if(self.pasteType ===3)
			{
				...
				if(html.search(/math/i) != -1)
				{
					html =  html.replace(/&lt;/g, "<").replace(/&gt;/g,  ">").replace(/&nbsp;/g,  "").replace(/<br \/>/g,  "").replace(/amp;/g,  "").replace(/display='block'/g,"").replace(/m:/,"mml:");
