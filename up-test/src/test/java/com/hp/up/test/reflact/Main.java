package com.hp.up.test.reflact;
...
/**
 * Created by haopeng on 2017/12/25 17:51
 */
public class Main {
    /**
    ...
    public static void Demo2() throws ClassNotFoundException {
        ...
        class1 = Class.forName("com.hp.up.test.reflact.Person");
        ...
        System.out.println("Demo2:(写法3) 包名: " + class3.getPackage().getName() + "，"
                + "完整类名: " + class3.getName());
    }
    ...
    public static void Demo6() throws ClassNotFoundException {
        Class<?> class1 = null;
        class1 = Class.forName("com.hp.up.test.reflact.SuperMan");
